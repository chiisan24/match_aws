...
Object.assign(UI_LABELS, {
  "planFirst.title": { ja: "今日の愛媛、こんな旅はいかがですか？", en: "How about one of these Ehime trips today?", iyo: "今日の愛媛、こんな旅はどうぞ？" },
  "planFirst.lead": { ja: "条件入力はあとで大丈夫。まずは、気になる旅をひとつ選んでください。", en: "No forms yet. Start by choosing a trip that catches your eye.", iyo: "条件はあとでええけん、まず気になる旅を選んでや。" },
  "planFirst.promise": { ja: "選んだ旅をもとに、AIが少しずつあなた向けに整えます", en: "AI will gently tailor the trip after you choose", iyo: "選んだ旅をもとに、AIがあんた向けに整えるけん" },
  ...
  "planFirst.viewDetail": { ja: "旅の中身を見る", en: "View this trip", iyo: "旅の中身を見る" },
  "planFirst.footer": { ja: "ぴったりがなくても大丈夫。選んだ後にワンタップで調整できます。", en: "Nothing exact? Choose the closest one and adjust it with a tap.", iyo: "ぴったりがなくても、選んだあとでちょっとずつ変えれるけん。" },
  "planFirst.back": { ja: "5つの旅に戻る", en: "Back to the five trips", iyo: "5つの旅に戻る" },
  ...
  "planFirst.start": { ja: "この旅で始める", en: "Start with this trip", iyo: "この旅で始めるけん" },
  "planFirst.startNote": { ja: "あとから予定を変更したり、AIに相談したりできます。", en: "You can change the plan or ask AI anytime later.", iyo: "あとから予定を変えたり、AIに相談したりできるけん。" },
...
Object.assign(UI_LABELS, {
  ...
  "planFirst.personalizedTitle": {
    ja: "あなたのための旅プラン",
    en: "A trip shaped for you",
    iyo: "あんたのための旅プラン",
  },
  "planFirst.personalizedLead": {
    ja: "「いいね」から好みを受け取り、AIが旅の流れを組み立てました。",
    en: "AI used your reaction to shape a simple itinerary.",
    iyo: "「ええね」から好みを受け取って、AIが旅を組み立てたけん。",
  },
